# untask-docs — working with project docs

Use this skill when you need to work with project documentation.

## Doc locations

- `.untask/docs/` — default docs directory (always scanned)
- `docs/` — also scanned by default
- Additional globs can be configured in `.untask/config.yml` under `docs:`

## Commands

| Command | Description |
|---------|-------------|
| `untask docs` | List all discovered docs |
| `untask docs show <name>` | Read a doc by name or path |
