...
- If no repair API exists: `"Run 'untask reindex' in terminal to fix"` — copy-pasteable command
...
The following are new features beyond the polish scope, tracked as untask tasks:
