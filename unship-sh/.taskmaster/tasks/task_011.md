...
5. **skill install** command:
   - Ship bundled `skill/unship.md`
   - Teach agents to start sessions with `unship next`, set status before work, mark done after work, and write docs/plans into tracked project locations
