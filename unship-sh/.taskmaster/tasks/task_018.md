...
**Description:** Build the desktop UI with project picker, sidebar, kanban board, task list, task detail with Milkdown editor, and docs viewer/editor, all aligned with `docs/unship-design-language.md`.

**Details:**

Implement the frontend UI. All visual work in this task should follow `docs/unship-design-language.md`:
...
2. Test folder selection offers inline initialization when `.unship/` is missing.
...
12. Verify the resulting UI matches `docs/unship-design-language.md` for typography, density, borders, chroma restraint, and priority-dot treatment.
