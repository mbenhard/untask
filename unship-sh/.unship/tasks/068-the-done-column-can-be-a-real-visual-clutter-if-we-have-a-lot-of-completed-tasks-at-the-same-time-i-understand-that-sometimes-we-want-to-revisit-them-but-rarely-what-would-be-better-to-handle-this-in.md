...
**Approach A (collapsible with recent-only default)** is the best fit for unship's design philosophy and current architecture.
...
3. **Progressive disclosure.** Users see what matters (recent completions) and can drill deeper on demand. This aligns with unship's “dense but calm” philosophy.
