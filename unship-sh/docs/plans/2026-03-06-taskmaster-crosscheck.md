...
1. `docs/plans/2026-03-06-unship-implementation.md`
2. `docs/plans/2026-03-06-unship-design.md`
3. `docs/unship-design-language.md` for UI-specific follow-through
...
6. Skill packaging now explicitly ships bundled `skill/unship.md` guidance instead of treating install as a generic config-file copy.
7. Desktop backend doc commands now honor configured `config.docs` globs rather than assuming `.unship/docs/` only.
...
10. Desktop UI tasks now explicitly reference `docs/unship-design-language.md`.
