...
- P2: Baseline subtask styling leaned too monospaced and widget-like for Unship's design language. Updated the component to use denser border-led rows, quieter progress treatment, and sans body copy while keeping mono only for utility metadata.
...
3. Frontend reviews in this repo need both `svelte-check` and a quick pass against the Unship design language.
